...
echo "var transactionRequestCoreOutput=`solc_0.4.24 --optimize --pretty-json --combined-json abi,bin,interface $TRANSACTIONREQUESTCORESOL`;" > $TRANSACTIONREQUESTCOREJS
echo "var requestFactoryOutput=`solc_0.4.24 --optimize --pretty-json --combined-json abi,bin,interface $REQUESTFACTORYSOL`;" > $REQUESTFACTORYJS
